      ...
      items: [
        {
          ...
          price: "300.000đ",
          duration: "60 phút",
          image: "/images/nail-art.jpg?height=200&width=300",
        ...
        },
        {
          ...
          image: "/images/nail-art.jpg?height=200&width=300",
          description:
            "Thiết kế nail nghệ thuật theo yêu cầu, độc đáo và sáng tạo",
        },
        {
          name: "Pedicure Spa",
          price: "350.000đ",
        ...
        },
        {
          ...
          image: "/images/nail-art.jpg?height=200&width=300",
          description:
            "Nối móng tự nhiên hoặc gel, tạo độ dài và hình dáng hoàn hảo",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          image: "/images/nail-art.jpg?height=200&width=300",
          description:
            "Điều trị mụn hiệu quả với công nghệ IPL và serum chuyên dụng",
        },
        {
          ...
          image: "/images/nail-art.jpg?height=200&width=300",
          description:
            "Massage nâng cơ, đắp mặt nạ collagen, serum chống lão hóa",
        },
        {
    ...
    <div className="min-h-screen py-16 lg:py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 lg:mb-20">
          <Badge className="mb-6 px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700">Dịch vụ của chúng tôi</Badge>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
            Dịch vụ chăm sóc sắc đẹp toàn diện
          </h1>
          <p className="text-lg text-muted-foreground max-w-4xl mx-auto leading-relaxed">
            Từ nail art nghệ thuật đến chăm sóc da chuyên nghiệp, chúng tôi có
            đầy đủ dịch vụ để bạn tỏa sáng với vẻ đẹp tự nhiên và rực rỡ nhất.
          </p>
        </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-0 h-full">
                      ...
                      <CardContent className="p-6 flex flex-col justify-between space-y-4">
                        ...
                        <div className="space-y-4">
                          ...
                          <Link href="/booking">
                            <Button className="w-full bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 cursor-pointer">
          ...
          <Card className="bg-muted/30 border-0 shadow-lg">
            <CardContent className="text-center p-12 space-y-6">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Liên hệ với chúng tôi để được tư vấn dịch vụ phù hợp nhất cho
                bạn
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/contact">
                  <Button size="lg" className="px-8 py-3 bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 cursor-pointer">
                    Liên hệ tư vấn
                  </Button>
                </Link>
                <Link href="/booking">
